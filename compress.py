...
from utils.general import labels_to_class_weights, TQDM_BAR_FORMAT,check_git_info, check_amp, increment_path, labels_to_image_weights, init_seeds, \
    strip_optimizer, get_latest_run, check_dataset, check_git_status, check_img_size, check_requirements, \
    check_file, check_yaml, check_suffix, print_args, set_logging, one_cycle, colorstr, methods, intersect_dicts, yaml_save
...
from utils.torch_utils import EarlyStopping, ModelEMA, de_parallel, select_device, \
    torch_distributed_zero_first, smart_DDP, smart_optimizer, smart_resume
...
def compress(model, dataloader, args):
    ...
    model_path = "/fb_isa/workspace_chy/yolov5/runs/train/exp5/compression/pruned_yolov5_640_global_coco_r0.pkl"
...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if not opt.pruned:
        ...
        hyp['cls'] *= nc / 25. * 3. / nl  # scale to classes and layers
